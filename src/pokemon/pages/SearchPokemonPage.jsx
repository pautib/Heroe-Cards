...
import {PokemonCard} from "../components/index.js";
import React from "react";
import {getPokemonByName} from "../helpers/index.js";
export const SearchHeroesPage = () => {
    ...
    const pokemon = getPokemonByName(query);
    const showAlert = query === "";
    const showError = query.length > 0 && pokemon.length === 0;
